...
use param, only: nxt, nynpy, nz, dx, dy, dz, coordz
use sim_param, only: u, v, w
use test_filtermodule
implicit none
! ---
real(kind=rprec), dimension(nz), intent(out):: Cs_opt2
real(kind=rprec), dimension(nxt, nynpy, nz), intent(in) :: S11, S12, S13, S22, S23, S33
! ---  
real(kind=rprec), dimension(nxt, nynpy) :: L11, L12, L13, L22, L23, L33,    &
                                           M11, M12, M13, M22, M23, M33
real(kind=rprec), dimension(nxt, nynpy) :: S_bar, S11_bar, S12_bar,         &
                S13_bar, S22_bar, S23_bar, S33_bar, S_S11_bar, S_S12_bar,   &
                S_S13_bar, S_S22_bar, S_S23_bar, S_S33_bar
real(kind=rprec), dimension(nxt, nynpy) :: u_bar, v_bar, w_bar
real(kind=rprec), dimension(nxt, nynpy) :: S
