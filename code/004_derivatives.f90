...
use param, only: nxt, nyt, nz, lhx, lhy, nxnpy, nynpy
implicit none
save
! ---
contains
...
!-----------------------------------------------------------------------
    ...
    ! ---
    integer :: iy, iz
    real(rprec), dimension(nxt, nynpy, 0:nz), intent(in) :: fun
    real(rprec), dimension(nxt, nynpy, 0:nz), intent(inout) :: dfdx
...
!-----------------------------------------------------------------------
    ...
    integer :: ix, iz
    real(rprec), dimension(nxt, nynpy, 0:nz), intent(in) :: fun
    real(rprec), dimension(nxt, nynpy, 0:nz), intent(inout) :: dfdy
    ! ---
...
!-----------------------------------------------------------------------
    ...
    ! ---
    real(rprec), dimension(nxt, nynpy, 0:nz), intent(in) :: fun
    real(rprec), dimension(nxt, nynpy, 0:nz), intent(inout) :: dfdz
...
!-----------------------------------------------------------------------
    ...
    implicit none
    ! ---
    real(rprec), dimension(nxt, 0:nynpy+1, 0:nz), intent(in) :: fun
    real(rprec), dimension(nxt, 0:nynpy+1, 0:nz), intent(inout) :: dfdz
    ...
    ! ---
    real(rprec), dimension(nxt, nynpy, 0:nz), intent(in) :: fun
    real(rprec), dimension(nxt, nynpy, 0:nz), intent(out) :: dfdz
    ! ---
    real(rprec) :: const
