...
use param, only:nxt, nyt, nxhnpy, nynpy, nz
use fft
implicit none
! ---
real(rprec), dimension(nxt, nynpy, 0:nz), intent(in)  :: var
real(rprec), dimension(nxt, nynpy, 0:nz), intent(out) :: var_d
! ---
real(rprec), dimension(nxt, nynpy, 0:nz) :: var_tmp
