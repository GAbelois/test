...
use param, only:nxt, nyt, rag06, fieldsize, fieldsize_stripe,    &
                field_xs, field_xe, field_ys, field_ye, z_ref, PCon_sfc
implicit none
save
public
! ---
...
real(kind=rprec), parameter :: zo1=0.08_rprec, zo2=0.125_rprec
