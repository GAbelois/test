...
! ---
call collect_data_3d_sp(u, u_tot)
call collect_data_3d_sp(v, v_tot)
call collect_data_3d_sp(w, w_tot)
call collect_data_3d_sp(p, p_tot)
call collect_data_3d_sp(theta, theta_tot)   
...
! ! ---
! call collect_data_3d_sp(p, p_tot)
! call collect_data2_3d_sp(dpdx, dpdx_tot)
! call collect_data2_3d_sp(dpdy, dpdy_tot)
...
! real(rprec) :: xx, yy, zz
! ! ---
! call collect_data_3d_sp(RHSx, RHSx_tot)
! call collect_data_3d_sp(RHSy, RHSy_tot)
! call collect_data_3d_sp(RHSz, RHSz_tot)
