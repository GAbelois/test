...
!--------------------------------------------------------------------!
use types, only: rprec
use param, only: nxt, nxt2, nynpy, ny2npy, lhx, lhx2, lhy, lhy2, nyt, nyt2, nx2npy
use fft 
implicit none
! --- note we're calling with 2D arrays
real(kind=rprec), dimension(nxt, nynpy), intent(in)  :: var
...
!--------------------------------------------------------------------!
use types, only: rprec
use param, only: nxt, nxt2, nxnpy, nynpy, ny2npy, lhx, lhx2, lhy, lhy2, nyt, nyt2
use fft 
implicit none
! --- note we're calling with 2D arrays
real(kind=rprec), dimension(nxt2, ny2npy), intent (in)  :: var_big
real(kind=rprec), dimension(nxt, nynpy), intent(out) :: var
! ---
